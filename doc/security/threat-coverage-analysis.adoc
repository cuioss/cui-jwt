...
|===
|Threat ID |Description |Coverage in Specifications |Coverage in Tests
|R1 |Denial of token usage |Covered in link:../Requirements.adoc#OAUTH-SHERIFF-7[OAUTH-SHERIFF-7: Logging] and implemented in link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/JWTValidationLogMessages.java[JWTValidationLogMessages] |Tested in various tests that verify logging
...
|R3 |Missing audit trail for token operations |Covered in link:../Requirements.adoc#OAUTH-SHERIFF-7[OAUTH-SHERIFF-7: Logging] and implemented in link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/JWTValidationLogMessages.java[JWTValidationLogMessages] |Tested in various tests that verify logging
...
|===
|Threat ID |Description |Coverage in Specifications |Coverage in Tests
|I1 |Exposure of sensitive claims in logs |Covered in link:../Requirements.adoc#OAUTH-SHERIFF-7.2[OAUTH-SHERIFF-7.2: Log Content] and implemented in link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/JWTValidationLogMessages.java[JWTValidationLogMessages] |Tested in various tests that verify logging
...
|I4 |Debug information exposure |Covered in link:../Requirements.adoc#OAUTH-SHERIFF-7.2[OAUTH-SHERIFF-7.2: Log Content] and implemented in link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/JWTValidationLogMessages.java[JWTValidationLogMessages] |Tested in various tests that verify logging
