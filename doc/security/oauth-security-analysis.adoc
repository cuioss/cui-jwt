...
* link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/pipeline/TokenClaimValidator.java[TokenClaimValidator.java:233-249] - Audience claim validation prevents token misuse across clients
* link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/pipeline/TokenClaimValidator.java[TokenClaimValidator.java:387-413] - Authorized Party (azp) validation verifies token was issued for the specific client
* link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/IssuerConfig.java[IssuerConfig.java] - Configuration enforces expectedClientId and expectedAudience validation
* Mandatory azp validation when expectedClientId is configured prevents cross-client token usage

==== Test Coverage

* link:../../oauth-sheriff-core/src/test/java/de/cuioss/jwt/validation/ClientConfusionAttackTest.java[ClientConfusionAttackTest] - Tests specifically for client confusion attacks:
...
* link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/domain/token/AccessTokenContent.java[AccessTokenContent.java] - Provides access to scope claims from validated tokens
...
* link:../../oauth-sheriff-core/src/main/java/de/cuioss/jwt/validation/pipeline/TokenClaimValidator.java[TokenClaimValidator.java] - Validates presence and format of subject (sub) claim
...
* link:../../oauth-sheriff-core/src/test/java/de/cuioss/jwt/validation/pipeline/TokenClaimValidatorTest.java[TokenClaimValidatorTest] - Tests specifically for mutable claims validation:
