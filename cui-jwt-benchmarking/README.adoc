...
The xref:../quarkus-integration-jmh/README.adoc[JWT Quarkus Integration JMH Benchmarking Module] provides end-to-end performance testing using the **identical scoring formula** as this micro-benchmark module:
