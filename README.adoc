...
image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_oauth-sheriff-core&metric=alert_status[Quality Gate Status,link=https://sonarcloud.io/summary/new_code?id=cuioss_oauth-sheriff-core]
image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_oauth-sheriff-core&metric=ncloc[Lines of Code,link=https://sonarcloud.io/summary/new_code?id=cuioss_oauth-sheriff-core]
image:https://sonarcloud.io/api/project_badges/measure?project=cuioss_oauth-sheriff-core&metric=coverage[Coverage,link=https://sonarcloud.io/summary/new_code?id=cuioss_oauth-sheriff-core]
