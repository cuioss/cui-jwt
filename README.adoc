...
cui.jwt.issuer.keycloak.issuer-identifier=https://keycloak.example.com/realms/master
cui.jwt.issuer.keycloak.http-jwks-loader-config.jwks-uri=https://keycloak.example.com/realms/master/protocol/openid-connect/certs
----
