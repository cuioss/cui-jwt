...
The xref:cui-jwt-quarkus-parent/quarkus-integration-jmh/README.adoc[JWT Quarkus Integration JMH Benchmarking Module] provides end-to-end performance testing using containerized environments. It measures:
