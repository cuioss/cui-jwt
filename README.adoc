...
The library requires a Jakarta JSON API implementation:
...
Test utilities are available via:
...
See xref:cui-jwt-validation/doc/UnitTesting.adoc[Test Utilities Documentation] for details.
...
* https://cuioss.github.io/cui-jwt/about.html[Generated Documentation on GitHub Pages]
* https://github.com/cuioss/cui-jwt[GitHub Repository]
* https://central.sonatype.com/artifact/de.cuioss.jwt/cui-jwt-parent[Maven Central]