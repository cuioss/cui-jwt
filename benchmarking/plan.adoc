...
* [ ] Execute library benchmarks: `./mvnw clean verify -pl benchmarking/benchmark-library -Pbenchmark`
* [ ] Execute integration benchmarks: `./mvnw clean verify -pl benchmarking/benchmark-integration-quarkus -Pbenchmark-testing`
...
* [ ] Run `./mvnw -Ppre-commit clean install -pl benchmarking/cui-benchmarking-common`
* [ ] Run `./mvnw -Ppre-commit clean install -pl benchmarking/benchmark-library`
* [ ] Execute JFR benchmarks: `./mvnw clean verify -pl benchmarking/benchmark-library -Pbenchmark-jfr`
