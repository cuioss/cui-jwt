...
The xref:../benchmark-integration-quarkus/README.adoc[JWT Quarkus Integration Benchmarks] provides end-to-end performance testing using the **identical scoring formula** as this micro-benchmark module:
