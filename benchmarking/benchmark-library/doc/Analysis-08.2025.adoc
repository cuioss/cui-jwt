...
*Ü [ ] Compare P99 results before/after entropy optimization
...
./mvnw verify -Pbenchmark -pl benchmarking/benchmark-library

# Component-level analysis
./mvnw verify -Pbenchmark-jfr -pl benchmarking/benchmark-library

# Thread scaling analysis
./mvnw verify -Pbenchmark -pl benchmarking/benchmark-library -Djmh.threads=1,50,100,150,200
----
