...
|link:oauth-sheriff-benchmarking-common/[oauth-sheriff-benchmarking-common]
|Shared infrastructure and utilities
|N/A (library)

|link:oauth-sheriff-benchmark-core/[oauth-sheriff-benchmark-core]
|JMH micro-benchmarks for JWT library
|< 10 minutes

|link:oauth-sheriff-benchmark-integration-wrk/[oauth-sheriff-benchmark-integration-wrk]
...
./mvnw verify -pl benchmarking/oauth-sheriff-benchmark-core -Pbenchmark-jfr
----
...
=== Micro Benchmarks (oauth-sheriff-benchmark-core)

Located in `benchmarking/oauth-sheriff-benchmark-core`:
...
See link:oauth-sheriff-benchmark-core/README.adoc[oauth-sheriff-benchmark-core README] for details.

=== Load Testing Benchmarks (oauth-sheriff-benchmark-integration-wrk)

Located in `benchmarking/oauth-sheriff-benchmark-integration-wrk`:
...
See link:oauth-sheriff-benchmark-integration-wrk/README.adoc[oauth-sheriff-benchmark-integration-wrk README] for details.

=== Common Infrastructure (oauth-sheriff-benchmarking-common)

Shared infrastructure providing benchmark framework, metrics collection, and artifact generation.

See link:oauth-sheriff-benchmarking-common/README.adoc[oauth-sheriff-benchmarking-common README] for details.
...
* link:oauth-sheriff-benchmark-core/doc/Analysis-08.2025.adoc[Benchmark Analysis (August 2025)] - Performance metrics and optimization insights
