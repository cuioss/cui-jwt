...
|Metrics Collection
|`PrometheusClient`, `PrometheusMetricsManager`, `MetricsOrchestrator`, `MetricsFileProcessor`
...
* `../../cui-jwt-quarkus-parent/cui-jwt-quarkus-integration-tests/scripts/` - Container lifecycle and monitoring
