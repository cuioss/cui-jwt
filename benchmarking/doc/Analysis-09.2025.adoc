...
| Threads | 4
| Connections | 100
| Total Requests | 2,202,982
| Throughput | 18,355 ops/s
| Transfer Rate | 15.16 MB/s
| Average Latency | 11.22 ms
| Latency Std Dev | 30.38 ms
| P50 Latency | 4.94 ms
| P75 Latency | 7.07 ms
| P90 Latency | 9.98 ms
| P99 Latency | 175.16 ms
| Max Latency | 613.26 ms
|===
...
1. **Baseline Throughput**: At 18,355 ops/s, Keycloak's realm endpoint performs comparably to the Quarkus health check endpoint (18,418 ops/s for WRK, 11,292 ops/s for JMH)

2. **Latency Characteristics**:
   - P50-P90 latencies (4.94-9.98 ms) are higher than Quarkus health checks (1.1-3.96 ms)
   - P99 shows significant tail latency (175.16 ms) suggesting occasional processing spikes
   - High standard deviation (30.38 ms) indicates variable response times
...
4. **Comparison Insights**:
   - Quarkus native health endpoints are 2-4× faster in latency
   - JWT validation endpoints (8,333 ops/s) show ~55% throughput reduction compared to simple realm retrieval
