 ...
 * <p>
 * Each instance is tied to a specific {@link HttpMeasurementType}, allowing the measurement
...
public final class ActiveMetricsTicker implements MetricsTicker {
     ...
     */
    @NonNull
    private final HttpMetricsMonitor monitor;

    /**
     * The type of measurement being recorded.
     */
    @NonNull
    private final HttpMeasurementType measurementType;
