...
public final class JwtPropertyKeys {
    ...
    public static final class METRICS {
        ...
        /**
         * Properties related to JWT validation metrics monitoring configuration.
         */
        @UtilityClass
        public static final class MONITOR {
            /**
             * Base path for monitor configurations.
             */
            public static final String BASE = PREFIX + ".metrics.monitor";

            /**
             * Whether metrics monitoring is enabled.
             * Template: "cui.jwt.metrics.monitor.enabled"
             * <p>
             * When set to {@code false}, no metrics monitoring will be performed,
             * effectively disabling all performance measurements. This can be used
             * to eliminate monitoring overhead in performance-critical environments.
             * </p>
             * <p>
             * Default value is {@code true}.
             * </p>
            ...
            /**
             * Window size for the rolling measurement buffer.
             * Template: "cui.jwt.metrics.monitor.window-size"
             * <p>
             * The number of recent measurements to keep in the rolling window for each
             * configured measurement type. Larger values provide more stable averages
             * but consume more memory. Smaller values react faster to performance changes
             * but may be more volatile.
             * </p>
             * <p>
             * Default value is {@code 100}.
             * </p>
             */
            public static final String WINDOW_SIZE = BASE + ".window-size";

            /**
             * Comma-separated list of measurement types to monitor.
             * Template: "cui.jwt.metrics.monitor.measurement-types"
             * <p>
             * Only the measurement types included in this list will be recorded.
             * All other measurement types will result in no-op operations.
             * If this property is empty or not set, no monitoring will be performed.
             * </p>
             * <p>
             * Valid values are the names of {@link de.cuioss.jwt.validation.metrics.MeasurementType} enum constants:
             * <ul>
             *   <li>COMPLETE_VALIDATION - End-to-end validation time</li>
             *   <li>TOKEN_PARSING - JWT parsing and structure validation</li>
             *   <li>HEADER_VALIDATION - JWT header validation</li>
             *   <li>SIGNATURE_VALIDATION - Cryptographic signature verification</li>
             *   <li>CLAIMS_VALIDATION - Token claims validation</li>
             *   <li>JWKS_OPERATIONS - JWKS key retrieval and processing</li>
             *   <li>TOKEN_FORMAT_CHECK - Basic token format validation</li>
             *   <li>ISSUER_EXTRACTION - Issuer extraction from decoded JWT</li>
             *   <li>ISSUER_CONFIG_RESOLUTION - Issuer configuration resolution</li>
             *   <li>TOKEN_BUILDING - Token object building</li>
             * </ul>
             * <p>
             * Use the special value "ALL" to monitor all available measurement types.
             * </p>
             * <p>
             * Example: "SIGNATURE_VALIDATION,COMPLETE_VALIDATION,JWKS_OPERATIONS"
             * </p>
             * <p>
             * Default value is "ALL" (all measurement types enabled).
             * </p>
             */
            public static final String MEASUREMENT_TYPES = BASE + ".measurement-types";
        }
    }
