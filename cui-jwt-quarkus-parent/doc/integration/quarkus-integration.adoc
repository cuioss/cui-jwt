...
cui.jwt.parser.allow-unsafe-algorithms=false
...
cui.jwt.issuers.keycloak.jwks.http.url=https://keycloak.example.com/auth/realms/master/protocol/openid-connect/certs
----
