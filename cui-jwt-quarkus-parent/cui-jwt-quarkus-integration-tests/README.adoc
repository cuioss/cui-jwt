...
# Manual testing
cui-jwt-quarkus-parent/cui-jwt-quarkus-integration-tests/scripts/start-integration-container.sh
...
./mvnw clean package -Pdocker-distroless

# JFR profiling build (187MB UBI-based image)
./mvnw clean package -Pdocker-jfr
...
The xref:../quarkus-integration-jmh/README.adoc[JWT Quarkus Integration JMH Benchmarking Module] builds upon this module's containerized infrastructure to provide performance benchmarking capabilities. It reuses:
