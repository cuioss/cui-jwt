...
RESULTS_DIR="$PROJECT_ROOT/cui-jwt-quarkus-parent/quarkus-integration-jmh/target/monitoring-results"
...
START_TIME=$(date +%s)
$MAVEN_CMD verify -pl cui-jwt-quarkus-parent/quarkus-integration-jmh -Pbenchmark > "$BENCHMARK_LOG" 2>&1 &
BENCHMARK_PID=$!
